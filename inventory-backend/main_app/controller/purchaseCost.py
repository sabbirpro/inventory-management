...
def list(request):
    ...
    try:
        model = PurchaseCost.objects.all()
        serializer = PurchaseCostListSerializer(
...
def single(request, id):
    ...
    try:
        model = PurchaseCost.objects.get(pk=id)
        serializer = PurchaseCostSerializer(
...
def edit(request, id):
    ...
    try:
        model = PurchaseCost.objects.get(pk=id)
        serializer = PurchaseCostSerializer(model, data=request.data, context={
