...
def list(request):
    ...
    try:
        model = PurchaseItem.objects.all()
        serializer = PurchaseItemListSerializer(
...
def single(request, id):
    ...
    try:
        model = PurchaseItem.objects.get(pk=id)
...
def edit(request, id):
    ...
    try:
        model = PurchaseItem.objects.get(pk=id)
        serializer = PurchaseItemSerializer(model, data=request.data, context={
