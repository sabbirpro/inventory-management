...
def list(request):
    ...
    try:
        model = SaleItem.objects.all()
        serializer = SaleItemListSerializer(
...
def single(request, id):
    ...
    try:
        model = SaleItem.objects.get(pk=id)
...
def edit(request, id):
    ...
    try:
        model = SaleItem.objects.get(pk=id)
        serializer = SaleItemSerializer(model, data=request.data, context={
